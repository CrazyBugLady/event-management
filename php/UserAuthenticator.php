	...
	class UserAuthenticator
	{
		...
		public static function AutoLogin()
		{
			if(isset($_COOKIE["UserId"]) && isset($_COOKIE["UserToken"]))
			{
				...
				$TokenComparisonString = self::encrypt("|" . $User->Password . "|" . $User->CreationDate . "|" . $User->Nickname . "|");
		...
		public static function logIn($User, $withAutoLogin)
		{
			...
			if($withAutoLogin)
			{
				...
				setcookie("UserToken",self::encrypt("|" . $User->Password . "|" . $User->CreationDate . "|" . $User->Nickname . "|"), time()+(3600*24*100));
			}
		}
